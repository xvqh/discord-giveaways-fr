...
exports.GiveawayMessages = {
    giveaway: '🎉 **GIVEAWAY** 🎉',
    giveawayEnded: '🎉🎉 **GIVEAWAY TERMINER** 🎉🎉',
...
exports.GiveawayRerollOptions = {
    winnerCount: null,
    messages: {
        congrat: ':tada: Nouveau gagnant(s): {winners}! Félicitations, vous avez gagné **{this.prize}**!',
        error: 'Aucune participations, aucun gagnant(s) peut être choisi!',
